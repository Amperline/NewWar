...
private:
	...
	float timeR = 0;
public:
	Weapon(sf::RenderWindow* window, std::list<Ammo*>* ammos, std::string name, ObjectStatus obStat, WeaponType type, LEVEL level, 
		sf::Vector2f normalScale, sf::Vector2f startPos);
